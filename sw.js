...
var CACHE_NAME = 'studytimer-web-v34';
...
var CORE_ASSETS = [
    ...
    './demo.css',
    './demo.js',
    './js/demo-profanity.js',
    './js/demo-quotes.js',
    './js/demo-cloud-sync.js',
    './js/demo-analytics.js',
    './js/demo-leaderboard.js',
    './js/demo-audio.js',
    './css/demo-base.css',
    './css/demo-workspace.css',
    './css/demo-leaderboard.css',
    './css/demo-themes.css',
    './css/demo-audio.css',
    './css/demo-sidebar.css',
    './css/demo-responsive.css',
    './assets/supabase.js',
    './style.css',
    './script.js',
    './assets/logo.png',
