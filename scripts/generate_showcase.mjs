...
const screenshots = [
  'screenshots/final/01_goals.jpg',
  'screenshots/final/02_pomodoro.jpg',
  'screenshots/final/03_insights.jpg',
  'screenshots/final/04_subjects_pie.jpg',
  'screenshots/final/05_subjects_tags.jpg',
  'screenshots/final/06_milestones.jpg',
  'screenshots/final/07_calendar.jpg',
  'screenshots/final/08_privacy_theme.jpg'
];
...
async function generateShowcase() {
  ...
  ctx.textAlign = 'left';
  ctx.fillText('StudyTimer • Complete Google Play Store Screenshot Suite', padding, 75);

  ctx.font = '900 20px MontserratBlack';
  ctx.fillStyle = '#4B5563';
  ctx.fillText('8 Play Store Screenshots (9:16 Aspect Ratio) • Pixel-Uniform Flagship Mockups & Pure Clean UI', padding, 115);
